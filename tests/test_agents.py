...
class TestSummarizerAgent(unittest.TestCase):
    ...
    def test_generate_tldr(self):
        ...
        abstract = "This paper presents a novel approach to quantum error correction using surface codes. " * 20
...
class TestIntegration(unittest.TestCase):
    ...
    def test_system_pipeline(self):
        ...
        with patch.object(summarizer, 'extract_pdf_text', return_value="Mock PDF content about quantum error correction"):
